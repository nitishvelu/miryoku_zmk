...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_GALLIUMCOLSTAGE)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_GALLIUMCOLSTAGE_FLIP
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_ALPHAS_GALLIUMCOLSTAGE)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_GALLIUMCOLSTAGE
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH
    #endif
  #endif
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_GALLIUMCOLSTAGE)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_GALLIUMCOLSTAGE_FLIP
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_EXTRA_GALLIUMCOLSTAGE)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_GALLIUMCOLSTAGE
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY
    #endif
  #endif
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_TAP_GALLIUMCOLSTAGE)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_GALLIUMCOLSTAGE_FLIP
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_TAP_GALLIUMCOLSTAGE)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_GALLIUMCOLSTAGE
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH
    #endif
  #endif
